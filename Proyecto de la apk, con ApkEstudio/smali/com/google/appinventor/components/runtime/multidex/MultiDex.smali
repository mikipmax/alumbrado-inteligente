...
.method public static install(Landroid/content/Context;Z)Z
    ...
    const-string v12, " should be backed by "

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    const-string v12, "runtime with built-in multidex capabilty but it\'s not the "

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    const-string v12, "case here: java.vm.version=\""
